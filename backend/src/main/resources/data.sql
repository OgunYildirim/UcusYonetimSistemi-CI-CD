...
('TK001', 1, 2, 1, CURRENT_TIMESTAMP + INTERVAL '1' DAY, CURRENT_TIMESTAMP + INTERVAL '1' DAY + INTERVAL '2' HOUR, 180, 162, 18, 'SCHEDULED'),
('TK002', 2, 3, 2, CURRENT_TIMESTAMP + INTERVAL '2' DAY, CURRENT_TIMESTAMP + INTERVAL '2' DAY + INTERVAL '1' HOUR, 174, 156, 18, 'SCHEDULED');
